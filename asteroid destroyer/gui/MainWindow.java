...
public class MainWindow extends JFrame implements WindowConstants {
    ...
    public MainWindow() {
        ...
        statusBar.setBackground(Color.WHITE); // Color de fondo para la barra de estado
        gamePanel.setBackground(Color.CYAN); // Color de fondo para el panel de juego
        actionBar.setBackground(Color.lightGray); // Color de fondo para la barra de acción
